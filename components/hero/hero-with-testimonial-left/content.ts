import type { HeroWithTestimonialLeftProps } from "./index";

/**
 * Default content for HeroWithTestimonialLeft component
 */
export const defaultContent: HeroWithTestimonialLeftProps = {
...
/**
 * Alternative content variations for HeroWithTestimonialLeft component
 */
export const contentVariations: HeroWithTestimonialLeftProps[] = [
  {
