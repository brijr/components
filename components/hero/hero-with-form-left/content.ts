import type { HeroWithFormLeftProps } from "./index";

/**
 * Default content for HeroWithFormLeft component
 */
export const defaultContent: HeroWithFormLeftProps = {
...
/**
 * Alternative content variations for HeroWithFormLeft component
 */
export const contentVariations: HeroWithFormLeftProps[] = [
  {
