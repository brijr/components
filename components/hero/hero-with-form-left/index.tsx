...
/**
 * Props for the HeroWithFormLeft component
 */
export interface HeroWithFormLeftProps {
  /** Main headline text */
  headline: string;
...
/**
 * Left-aligned hero section with an inline form for lead capture.
 * Perfect for email signups, early access, or simple contact forms with left-aligned layout.
 *
 * @example
 * ```tsx
 * <HeroWithFormLeft
 ...
 * ```
 */
export const HeroWithFormLeft = ({
  headline,
  subheadline,
  form,
  helperText,
  secondaryCTA,
}: HeroWithFormLeftProps) => {
...
/**
 * JSON Schema for HeroWithFormLeft component
 */
export const heroWithFormLeftSchema = {
  type: "object",
  properties: {
    headline: {
      type: "string",
