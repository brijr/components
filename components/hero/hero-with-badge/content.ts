import type { HeroWithBadgeProps } from "./index";

/**
 * Default content for HeroWithBadge component
 */
export const defaultContent: HeroWithBadgeProps = {
  badge: {
    text: "New Release",
    variant: "secondary",
    href: "/changelog",
...
/**
 * Alternative content variations for HeroWithBadge component
 */
export const contentVariations: HeroWithBadgeProps[] = [
  {
    badge: {
      text: "Limited Offer",
      variant: "destructive",
