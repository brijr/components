import type { HeroWithTabsProps } from "./index";

/**
 * Default content for HeroWithTabs component
 */
export const defaultContent: HeroWithTabsProps = {
...
/**
 * Alternative content variations for HeroWithTabs component
 */
export const contentVariations: HeroWithTabsProps[] = [
  {
