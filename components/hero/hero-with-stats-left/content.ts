import type { HeroWithStatsLeftProps } from "./index";

/**
 * Default content for HeroWithStatsLeft component
 */
export const defaultContent: HeroWithStatsLeftProps = {
...
/**
 * Alternative content variations for HeroWithStatsLeft component
 */
