  ...
  posts: [
    {
      ...
      excerpt:
        "A deep dive into microservices, serverless, and edge computing in modern web applications. Learn how these technologies work together to create scalable, performant applications.",
      thumbnail: {
        src: "/placeholder.svg",
    ...
    },
    {
      ...
      excerpt:
        "Compare different state management solutions in React applications, from Context API to Redux, Zustand, and more. Find the right solution for your project.",
      thumbnail: {
        src: "/placeholder.svg",
    ...
    },
    {
      ...
      excerpt:
        "Learn how to create a comprehensive design system for your organization, including components, tokens, documentation, and governance.",
      thumbnail: {
        src: "/placeholder.svg",
    ...
    },
    {
      ...
      excerpt:
        "Discover advanced techniques to optimize your Next.js applications, including code splitting, image optimization, and caching strategies.",
  ...
  // Minimal list without thumbnails
  {
    ...
    posts: [
      ...
      },
      {
        ...
        excerpt:
          "Best practices for implementing security in Node.js applications.",
      ...
      },
      {
        ...
        excerpt:
          "A practical comparison of GraphQL and REST APIs for modern applications.",
    ...
    posts: [
      {
        ...
        excerpt:
          "Essential guidelines for running Kubernetes clusters in production environments, covering security, scalability, and monitoring.",
        thumbnail: {
          src: "/placeholder.svg",
      ...
      },
      {
        ...
        excerpt:
          "Comprehensive testing approaches for microservices architecture, including unit, integration, and end-to-end testing.",
        thumbnail: {
          src: "/placeholder.svg",
          alt: "Testing pyramid",
        },
    ...
    posts: [
      {
        ...
        excerpt:
          "Learn how to track and measure the return on investment of your content marketing efforts with practical metrics and tools.",
        thumbnail: {
          src: "/placeholder.svg",
      ...
      },
      {
        ...
        excerpt:
          "Strategies for establishing your brand as an industry leader through strategic content and positioning.",
        thumbnail: {
          src: "/placeholder.svg",
          alt: "Brand strategy",
        },
      ...
      },
      {
        ...
        excerpt:
          "Maximize your B2B marketing efforts on LinkedIn with proven strategies for organic and paid campaigns.",
