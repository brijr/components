  ...
  posts: [
    {
      ...
      excerpt:
        "Learn how to leverage the power of React Server Components in your Next.js applications for better performance and developer experience.",
      image: {
        src: "/placeholder.svg",
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive guide to implementing accessibility best practices in your React applications from the ground up.",
      image: {
        src: "/placeholder.svg",
...
export const contentVariations = [
  // Two column layout
  {
    ...
    posts: [
      ...
      },
      {
        ...
        excerpt:
          "Understanding the differences and best use cases for CSS Grid and Flexbox layouts.",
        image: {
          src: "/placeholder.svg",
  ...
  // Content marketing focused
  {
    ...
    description:
      "Stay ahead with the latest marketing strategies and case studies",
    posts: [
      {
        id: "1",
        title: "The Psychology of Color in Brand Design",
        excerpt:
          "How color choices impact customer perception and buying decisions in digital marketing.",
        image: {
          src: "/placeholder.svg",
      ...
      },
      {
        ...
        excerpt:
          "Proven strategies to improve your email open rates and conversions in the current landscape.",
        image: {
          src: "/placeholder.svg",
      ...
      },
      {
        ...
        excerpt:
          "Cut through the noise and focus on SEO strategies that deliver real results for your business.",
        image: {
          src: "/placeholder.svg",
          alt: "SEO analytics",
        },
