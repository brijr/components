export const defaultContent = {
  ...
  featuredPost: {
    ...
    excerpt:
      "Exploring how artificial intelligence is revolutionizing the way we write, test, and deploy code. From AI-powered code completion to automated testing and deployment strategies.",
    image: {
      src: "/placeholder.svg",
  ...
  secondaryPosts: [
    {
      ...
      excerpt:
        "Essential design patterns that will make your code more maintainable and scalable.",
      category: "JavaScript",
      date: "2024-01-23",
    ...
    },
    {
      ...
      excerpt:
        "Best practices for designing and implementing GraphQL APIs that can grow with your application.",
      category: "Backend",
      date: "2024-01-22",
    ...
    },
    {
      ...
      excerpt:
        "Key metrics, tools, and techniques for optimizing web performance in modern applications.",
...
export const contentVariations = [
  // Tech news focused
  {
    ...
    featuredPost: {
      ...
      excerpt:
        "Security researchers have uncovered a critical vulnerability affecting millions of applications. Here's what you need to know and how to protect your systems.",
      image: {
        src: "/placeholder.svg",
    ...
    secondaryPosts: [
      {
        ...
        excerpt:
          "Update your systems immediately to protect against this vulnerability.",
        category: "Updates",
        date: "2024-01-26",
  ...
  // Product updates focused
  {
    ...
    featuredPost: {
      ...
      excerpt:
        "We're excited to announce our new analytics dashboard that uses machine learning to provide actionable insights from your data automatically.",
      image: {
        src: "/placeholder.svg",
    ...
    secondaryPosts: [
      {
        ...
        excerpt:
          "New features including offline mode and biometric authentication.",
        category: "Mobile",
        date: "2024-01-22",
      ...
      },
      {
        ...
        excerpt:
          "We've doubled the API rate limits for all Pro and Enterprise plans.",
        category: "API",
        date: "2024-01-20",
  ...
  // Industry insights
  {
    ...
    featuredPost: {
      ...
      excerpt:
        "How edge computing is transforming enterprise software architecture, enabling real-time processing and reducing latency for critical applications.",
      image: {
        src: "/placeholder.svg",
    ...
    secondaryPosts: [
      {
        ...
        excerpt:
          "Practical approaches to reduce cloud spending without sacrificing performance.",
        category: "Cloud",
        date: "2024-01-21",
      ...
      },
      {
        ...
        excerpt:
          "When to choose each architecture based on your team and project needs.",
      ...
      },
      {
        ...
        excerpt:
          "Three years later: lessons learned and best practices for compliance.",
        category: "Compliance",
        date: "2024-01-18",
