...
export const Wrapper = ({
  ...
  return (
    <div
      id={path}
      className="w-full group bg-background drop-shadow-md hover:drop-shadow-xl border rounded-lg transition-all max-w-6xl md:max-h-[848px] sm:m-2 overflow-hidden no-scrollbar"
    >
