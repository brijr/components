				...
				<Craft.Container className="grid gap-6 md:grid-cols-2">
					<div className="grid gap-6">
						<Link href="/">
							...
							<Image className="dark:invert" src={Logo} alt="Logo" width={100} height={50}></Image>
						</Link>
						<p>
							<Balancer>
								Craft UI is a design system and component library for building NextJS Websites.
								Created by <a href="https://bridger.to">Bridger Tower</a> and{' '}
						...
						<div className="flex flex-col gap-2">
							...
							<ul>
								{links[0].links.map((link) => (
									<li key={link.title}>
										<Link className="hover:opacity-75 transition-all" href={link.href}>
											{link.title}
										</Link>
									</li>
								))}
