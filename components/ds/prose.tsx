  ...
  return (
    <Component
      className={cn(
        ...
        "[&_ul>li]:before:bg-foreground/80 [&_ul>li]:before:absolute [&_ul>li]:before:top-[0.6875em] [&_ul>li]:before:left-1 [&_ul>li]:before:h-1.5 [&_ul>li]:before:w-1.5 [&_ul>li]:before:rounded-full [&_ul>li]:before:content-['']",
        ...
        "[&_dd]:text-muted-foreground [&_dd]:text-sm [&_dd]:leading-snug",
        // List item base styling
        "[&_li]:marker:text-foreground/80 [&_li]:pl-2",
        "[&_li>ol]:mt-2 [&_li>ol]:mb-0 [&_li>ul]:mt-2 [&_li>ul]:mb-0",
        "[&_ul>ul>li]:before:bg-foreground/60",
        "[&_ul>ul>ul>li]:before:bg-foreground/40",
        // Code blocks
        "[&_code:not(pre_code)]:bg-muted/50 [&_code:not(pre_code)]:rounded [&_code:not(pre_code)]:border [&_code:not(pre_code)]:px-1 [&_code:not(pre_code)]:py-px [&_code:not(pre_code)]:font-mono [&_code:not(pre_code)]:text-sm [&_code:not(pre_code)]:font-medium",
        // Title code blocks
        ...
        // Pre blocks
        "[&_pre]:bg-muted/50 [&_pre]:my-4 [&_pre]:overflow-x-auto [&_pre]:rounded-sm [&_pre]:border [&_pre]:p-4",
        ...
        // Block elements
        "[&_blockquote]:border-border [&_blockquote]:text-muted-foreground [&_blockquote]:bg-muted/30 [&_blockquote]:my-4 [&_blockquote]:border-l-4 [&_blockquote]:py-2 [&_blockquote]:pl-4!",
        "[&_hr]:border-border/50 [&_hr]:my-8! [&_hr]:border-t-2",
        "[&_p:has(>hr)]:border-border/50 [&_p:has(>hr)]:my-8! [&_p:has(>hr)]:border-t-2",
        ...
        "[&_kbd]:bg-muted [&_kbd]:rounded-sm [&_kbd]:border [&_kbd]:px-1.5 [&_kbd]:py-0.5 [&_kbd]:align-middle [&_kbd]:font-mono [&_kbd]:text-sm [&_kbd]:shadow-xs",
        // Abbreviations
        "[&_abbr]:decoration-muted-foreground [&_abbr]:cursor-help [&_abbr]:border-b [&_abbr]:border-dotted [&_abbr]:underline-offset-2",
